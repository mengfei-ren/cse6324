...
public class MethodSignature {
	...
	public MethodSignature(boolean isStatic, Primitives returnType, String name, ArrayList<Variable> parameterList) {
		super();
	...
	/**
	 * returns the String form of the MethodSignature eg: int add(int x, int y)
	 */
	...
	public boolean equals(Object obj) {
		/*
		 * not necessary to override hashcode as we are not persisting these objects in
		...
		for (int i = 0; i < size; i++) {
			if (!this.parameterList.get(i).equals(obj1.parameterList.get(i))) {
				return false;
			}
		}
		return true;
