...
public class Method {
	 ...
	 * 
	 * @param signature
	 *            : signature of the method to be constructed
	 * @param associatedClass
	 *            : class to which the method belongs
	 * @param classList
	 *            : list of generated types
	 * @param locPerMethod
	 *            : lines of code for this method
	 * @param maxNestedIfs
	 *            : upper limit on the nested ifs.
	 * @param maxAllowedMethodCalls
	 *            : upper limit on the method calls.
	 */
	private Method(MethodSignature signature, ClassGenerator associatedClass, ArrayList<ClassGenerator> classList,
			int locPerMethod, int maxNestedIfs, int maxAllowedMethodCalls) {
	 ...
	 * @return
	 */
	public static Method getMethod(MethodSignature signature, ClassGenerator associatedClass,
			ArrayList<ClassGenerator> classList, int loc, int maxNestedIfs, int maxMethodCalls) {
	...
	/**
	 * Constructor that creates a method with/without generating the method body
	 * based on the generateMethodBody parameter.
	 * 
	 * @param isStatic
	 ...
	 */
	private Method(boolean isStatic, int numberOfParams, ClassGenerator associatedClass,
			ArrayList<ClassGenerator> classList, String name, int locPerMethod, int maxNestedIfs,
			int maxAllowedMethodCalls, boolean generateMethodBody) {
	...
	private void generateParams() {
		if (ProgGenUtil.methodCallType == CallType.crossClassWithRecursionLimit
			...
			for (int i = 1; i < numberOfParams; i++) { // classList is passed because: if Variable's type is Object,
														// then to select type
	 ...
	 * @return
	 */
	public static Method generateMethod(ClassGenerator generator, int maxNumberOfParams,
			ArrayList<ClassGenerator> classList, String name, int maxLocPerMethod, int maxNestedIfs,
			int maxAllowedMethodCalls, boolean generateMethodBody) {
		...
		return new Method(isStatic, numberOfParams, generator, classList, name, maxLocPerMethod, maxNestedIfs,
				maxAllowedMethodCalls, generateMethodBody);
	}
	...
	/**
	 * API to generate methods for an interface. Generated methods will not have a
	 * body generated. Such methods are used only for extracting signatures.
	 * 
	 ...
	 * @return
	 */
	public static Method generateMethodForInterface(int maxNoOfParameters, ArrayList<ClassGenerator> classList,
			String name) {
