...
/**
 * This class represents a <query> element in the QueryFile fed into RUGRAT.
 * 
 * @author balamurugan
 *
 */
public class Query {
	...
	public Query(String queryString, ArrayList<QueryResult> results, Set<Primitives> resultTypes) {
		super();
